        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-16 pb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="md:col-span-2 lg:col-span-1">
              ...
              <div className="h-14 w-48 bg-white flex items-center justify-center rounded-md mb-6">
                <span className="text-text font-heading font-bold text-xl">
                  SOMVANSH
                </span>
              </div>
              <p className="text-sm leading-relaxed text-gray-400 mb-6">
                Your trusted offshore software development partner from Pune, India. Engineering the future of enterprise technology with AI automation, custom SaaS solutions, and digital transformation strategies.
              </p>
              
              {/* Contact List */}
              <div className="space-y-3 text-sm">
                <a href="mailto:somvanshitechnologies@gmail.com" className="flex items-center gap-3 hover:text-white transition-colors">
                  <MailIcon />
                  <span>somvanshitechnologies@gmail.com</span>
                </a>
                <a href="mailto:ceo@somvanshitechnologies.com" className="flex items-center gap-3 hover:text-white transition-colors">
                  <MailIcon />
                  <span>ceo@somvanshitechnologies.com</span>
                </a>
                <a href="tel:+919637507575" className="flex items-center gap-3 hover:text-white transition-colors">
                  <PhoneIcon />
                  <span>+91 96375 07575</span>
                </a>
                <a href="tel:+919171018101" className="flex items-center gap-3 hover:text-white transition-colors">
                  <PhoneIcon />
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-5">
              ...
              <a href="mailto:somvanshitechnologies@gmail.com" aria-label="Email" className="text-gray-400 hover:text-white transition-colors">
                <MailIcon />
              </a>
            </div>
          </div>
